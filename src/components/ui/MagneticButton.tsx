  ...
  return (
    <button
      ...
      style={{
        ...
        padding: "14px 32px",
        borderRadius: "100px",
        border: isPrimary ? "none" : "1px solid rgba(99,155,255,0.3)",
        background: isPrimary ? "linear-gradient(135deg, #3b82f6 0%, #6366f1 100%)" : "transparent",
        color: isPrimary ? "#ffffff" : "rgba(180,210,255,0.85)",
        fontSize: "14px",
        fontWeight: 500,
